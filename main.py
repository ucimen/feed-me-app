...
<style>
    ...
    /* 2. BAŞARI EKRANI ORTALAMA */
    .success-container {
        display: flex; flex-direction: column; justify-content: center; align-items: center;
        text-align: center; padding: 40px; margin-top: 50px;
        background-color: #F8F9FA; border-radius: 16px;
        border: 1px solid #E0E0E0; box-shadow: 0 4px 20px rgba(0,0,0,0.05);
    }
    .success-title { color: #00C4B4; font-weight: 900; font-size: 2rem; margin-bottom: 10px; }
    .success-text { color: #555; font-size: 1.2rem; margin-bottom: 30px; }

    /* 3. AKORDİYON (EXPANDER) */
    div[data-testid="stExpander"] {
        border: 1px solid #F0F2F6 !important; border-radius: 8px !important;
        background-color: #FFFFFF !important; margin-bottom: 10px !important;
    }
    div[data-testid="stExpander"] details summary {
        display: flex !important; justify-content: center !important; align-items: center !important;
        color: #00C4B4 !important; font-weight: 700 !important; font-size: 1.1rem !important;
        padding: 10px !important;
    }
    div[data-testid="stExpander"] details summary svg { fill: #00C4B4 !important; color: #00C4B4 !important; margin-right: 8px !important; }
    div[data-testid="stExpander"] details div[data-testid="stMarkdownContainer"] { padding-bottom: 20px; }
    ...
    .stTextInput input:disabled { background-color: #F0F2F6 !important; color: #999999 !important; cursor: not-allowed !important; }

    /* 5. BUTONLAR */
    div.stButton > button, div[data-testid="stFormSubmitButton"] > button {
        background-color: #00C4B4 !important; border: none !important; border-radius: 8px !important;
        color: #FFFFFF !important; padding: 10px 24px !important; width: 100%;
    }
    div.stButton > button p, div[data-testid="stFormSubmitButton"] > button p { color: #FFFFFF !important; font-weight: 700 !important; font-size: 16px !important; }
    div.stButton > button:hover, div[data-testid="stFormSubmitButton"] > button:hover {
        background-color: #00A896 !important; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(0,196,180,0.4);
    }
    
    /* İkincil Butonlar (SİL & LOGOUT) */
    button[kind="secondary"] {
        background-color: #FFEBEE !important; color: #FF5252 !important;
        border: 1px solid #FFCDD2 !important; font-weight: 700 !important;
        padding-top: 10px !important; padding-bottom: 10px !important;
    }
    button[kind="secondary"]:hover { background-color: #FF5252 !important; color: #FFFFFF !important; border-color: #FF5252 !important; }
    button[kind="secondary"] p { color: #FF5252 !important; }
    button[kind="secondary"]:hover p { color: #FFFFFF !important; }

    /* 6. DİĞER */
    div[data-testid="stCode"] { background-color: #FFFFFF !important; border: 1px solid #E0E0E0 !important; border-radius: 8px !important; }
